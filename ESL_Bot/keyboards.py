...
def continue_keyboard(lang):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text=TEXTS[lang]['continue'], callback_data='continue_after_sub')]
        ]
    )
...
def subscription_keyboard(lang):
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text=TEXTS[lang]['subscribe'], url='https://t.me/ESL_Proficiency')]
        ]
    )
